        ...
        $pipeline = [
            ...
            [
                '$project' => [
                    ...
                    'is_on' => [
                        '$cond' => [
                            'if' => ['$gt' => ['$U_15_ActivePower_Total_kW', 1]],
                            'then' => 1,
                            'else' => 0
                        ]
                    ]
...
function fetchConsumption($collection, $start_date, $end_date) {
    try {
        ...
        $first_value = $results[0]['U_15_ActiveEnergy_Delivered_kWh'];
        $last_value = $results[count($results) - 1]['U_15_ActiveEnergy_Delivered_kWh'];
