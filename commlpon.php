        ...
        $pipeline = [
            ...
            [
                '$project' => [
                    ...
                    'is_on' => [
                        '$cond' => [
                            'if' => ['$gt' => ['$U_8_EM8_Activepower_Total_W', 1]],
                            'then' => 1,
                            'else' => 0
                        ]
                    ]
...
function fetchConsumption($collection, $start_date, $end_date) {
    try {
        ...
        $first_value = $results[0]['U_8_EM8_TotalActiveEnergy_kWh'];
        $last_value = $results[count($results) - 1]['U_8_EM8_TotalActiveEnergy_kWh'];
