...
if ($dateRangeLabel == 'Custom Range') {
    ...
    $select_fields = array(
        ...
        'PLC_Date_Time' => 1,
        'UNIXtimestamp' => 1,
        'U_3_EM3_Activepower_Total_W' => 1,
        'U_4_EM4_Activepower_Total_W' => 1,
        'U_5_EM5_Activepower_Total_W' => 1,
        'U_6_EM6_Activepower_Total_W' => 1,
        'U_7_EM7_ActivePowerTotal_kW' => 1,
        'U_8_EM8_Activepower_Total_W' => 1,
        'U_9_EM9_ActivePowerTotal_kW' => 1,
        'U_10_EM10_Activepower_Total_W' => 1,
        'U_21_ActivePower_Total_kW' => 1,
        'U_15_ActivePower_Total_kW' => 1,
        'U_22_ActivePower_Total_kW' => 1
    );
    ...
    foreach ($docs as $document) {
        ...
        $meters = [
            'U_3_EM3_Activepower_Total_W',
            'U_4_EM4_Activepower_Total_W',
            'U_5_EM5_Activepower_Total_W',
            'U_6_EM6_Activepower_Total_W',
            'U_7_EM7_ActivePowerTotal_kW',
            'U_8_EM8_Activepower_Total_W',
            'U_9_EM9_ActivePowerTotal_kW',
            'U_10_EM10_Activepower_Total_W',
            'U_21_ActivePower_Total_kW',
            'U_15_ActivePower_Total_kW',
            'U_22_ActivePower_Total_kW'
        ];
